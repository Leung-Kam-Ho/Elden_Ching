            ...
            <div class="expandcontent" id="hi">
                <main class="grid">
                    <div class="img-container">
                        <img src="<?php echo e(url('/images/computer.png')); ?>" class="image">
                        <a href="<?php echo e('/phone'); ?>">
                            <div class="overlay">
                    ...
                    <div class="img-container">
                        <img src="<?php echo e(url('/images/phone.png')); ?>" class="image">
                        <a href="<?php echo e('/phone'); ?>">
                            <div class="overlay">
                    ...
                    <div class="img-container">
                        <img src="<?php echo e(url('/images/mouse.png')); ?>" class="image">
                        <a href="<?php echo e('/phone'); ?>">
                            <div class="overlay">
                    ...
                    <div class="img-container">
                        <img src="<?php echo e(url('/images/TV.png')); ?>" class="image">
                        <a href="<?php echo e('/phone'); ?>">
                            <div class="overlay">
